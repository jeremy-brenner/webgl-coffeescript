...
(function() {
  ...
  webGLLesson01 = (function() {
    function webGLLesson01(canvas_id) {
    ...
    webGLLesson01.prototype.shaderFs = function() {
      return "precision mediump float;\n\nvoid main(void) {\n  gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);\n}";
    };

    webGLLesson01.prototype.shaderVs = function() {
      return "attribute vec3 aVertexPosition;\n\nuniform mat4 uMVMatrix;\nuniform mat4 uPMatrix;\n\nvoid main(void) {\n    gl_Position = uPMatrix * uMVMatrix * vec4(aVertexPosition, 1.0);\n}";
    };

    webGLLesson01.prototype.initGL = function() {
      this.gl = this.canvas.getContext("experimental-webgl");
      this.gl.viewportWidth = this.canvas.width;
      return this.gl.viewportHeight = this.canvas.height;
    };

    webGLLesson01.prototype.createMatrices = function() {
      this.mvMatrix = mat4.create();
      return this.pMatrix = mat4.create();
    };

    webGLLesson01.prototype.initShaders = function() {
    ...
    webGLLesson01.prototype.getShader = function(t, c) {
      var shader;
    ...
    webGLLesson01.prototype.drawScene = function() {
    ...
    return webGLLesson01;

  })();

  jQuery(function() {
    return web_gl_lessons.add("Lesson01", webGLLesson01);
  });
